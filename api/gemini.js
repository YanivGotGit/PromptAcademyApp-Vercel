...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const model = genAI.getGenerativeModel({ model: "gemini-2.0-pro-latest" });
    ...
    if (type === 'identify_persona') {
      ...
      const modelForJson = genAI.getGenerativeModel({ model: "gemini-2.0-pro-latest", generationConfig: { responseMimeType: "application/json", temperature: 0 } });
